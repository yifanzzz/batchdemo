package cn.test.demo.step.item;
...
public class MySimpleChunkProcessor<I, O> implements ChunkProcessor<I>, InitializingBean {
    ...
    private MySimpleChunkProcessor() {
        this(null, null);
    }

    public MySimpleChunkProcessor(@Nullable ItemProcessor<? super I, ? extends O> itemProcessor, ItemWriter<? super O> itemWriter) {
        this.itemProcessor = itemProcessor;
        this.itemWriter = itemWriter;
    }

    public MySimpleChunkProcessor(ItemWriter<? super O> itemWriter) {
